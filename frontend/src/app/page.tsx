  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      heroTl
        ...
        .from('.hero-w1', { y: 120, opacity: 0, scale: 0.95, filter: 'blur(15px)', duration: 1.4 }, 0.3)
        .from('.hero-w2', { y: 120, opacity: 0, scale: 0.95, filter: 'blur(15px)', duration: 1.4 }, 0.5)
      ...
      if (numSection) {
        ...
        tl.from('.big-num', { scale: 0.5, opacity: 0, filter: 'blur(20px)', duration: 0.6, ease: 'power3.out' }, 0);
      ...
      if (modelsSection) {
        ...
        modelsSection.querySelectorAll('.model-score').forEach((el) => {
          ...
          gsap.to(valObj, {
            ...
            onUpdate: () => { htmlEl.textContent = String(Math.round(valObj.v)); },
          });
        });
      }
  ...
  return (
    <div ref={mainRef}>
      <style jsx global>{`
        ...
        @keyframes breathe { 0%,100% { box-shadow:0 0 30px rgba(230,57,70,0.08); } 50% { box-shadow:0 0 70px rgba(230,57,70,0.22); } }
      ...
      <main style={{ background: '#0A0A0A' }}>
        ...
        <div style={{
          ...
          opacity: globeReady ? 0 : 1, pointerEvents: globeReady ? 'none' : 'auto',
          transition: 'opacity 0.8s ease',
        }}>
          <div style={{ width: 48, height: 48, borderRadius: '50%', border: '2px solid #1A1A1A', borderTopColor: '#E63946', animation: 'spin 1s linear infinite' }} />
          <div style={{ fontFamily: "'Playfair Display',serif", fontSize: '1.2rem', fontWeight: 700, color: '#F0ECE4' }}>
            pixel<span style={{ color: '#E63946', fontStyle: 'italic' }}>Prejudice</span>
          </div>
          <div style={{ fontFamily: 'Inter', fontSize: '0.6rem', color: '#5A5548', letterSpacing: 2, textTransform: 'uppercase' }}>
        ...
        <div ref={globeWrapRef} style={{
          ...
          {mounted && (
            <Globe
              ...
              atmosphereColor="#E63946" atmosphereAltitude={0.2} showGraticules={false} globeImageUrl=""
              polygonsData={countries}
              polygonCapColor={() => 'rgba(35,33,30,0.92)'} polygonSideColor={() => 'rgba(35,33,30,0.5)'}
              polygonStrokeColor={() => 'rgba(200,180,160,0.06)'} polygonAltitude={0.005}
              pointsData={pts} pointLat="lat" pointLng="lng" pointAltitude="altitude" pointRadius="size" pointColor="color" pointsMerge={false}
              ...
              arcDashLength={0.5} arcDashGap={0.15} arcDashAnimateTime={3000} arcStroke={0.35}
              ringsData={rings} ringLat="lat" ringLng="lng" ringMaxRadius="maxR" ringPropagationSpeed="propagationSpeed" ringRepeatPeriod="repeatPeriod" ringColor="color"
            />
          )}
        </div>
        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          <section style={{
            ...
            <div className="hero-kicker" style={{
              ...
              letterSpacing: 4, color: '#E63946', textTransform: 'uppercase', marginBottom: '2.5rem',
            }}>An Investigation into AI Vision Bias</div>
            <h1 style={{ margin: 0, overflow: 'hidden' }}>
              <span className="hero-w1" style={{
                display: 'block', fontFamily: "'Playfair Display',Georgia,serif",
                fontSize: 'clamp(5rem,14vw,12rem)', fontWeight: 700, lineHeight: 0.85, letterSpacing: '-6px',
                color: 'rgba(240,236,228,0.95)', textShadow: '0 4px 80px rgba(0,0,0,0.9)',
              }}>pixel</span>
              <span className="hero-w2" style={{
                display: 'block', fontFamily: "'Playfair Display',Georgia,serif",
                fontSize: 'clamp(5rem,14vw,12rem)', fontWeight: 700, lineHeight: 0.85, letterSpacing: '-6px',
                color: '#E63946', fontStyle: 'italic', textShadow: '0 4px 80px rgba(230,57,70,0.3)',
              }}>Prejudice</span>
            </h1>
            <div className="hero-bottom" style={{ marginTop: '4rem' }}>
          ...
          <section className="s-problem" style={{
            height: '100vh', display: 'flex', alignItems: 'center',
            padding: '0 clamp(3rem,8vw,10rem)',
          }}>
            <div>
              <div style={{ fontFamily: 'Inter', fontSize: '0.55rem', fontWeight: 700, letterSpacing: 3, color: '#E63946', textTransform: 'uppercase', marginBottom: '2rem' }}>
                <span className="word" style={{ display: 'inline-block' }}>The Problem</span>
              </div>
              <h2 style={{ fontFamily: "'Playfair Display'", fontSize: 'clamp(2.2rem,5vw,4.2rem)', fontWeight: 700, color: '#F0ECE4', lineHeight: 1.15, letterSpacing: '-2px', maxWidth: 750, margin: 0 }}>
                <Words text="AI models don't just see faces." />
              </h2>
              <h2 style={{ fontFamily: "'Playfair Display'", fontSize: 'clamp(2.2rem,5vw,4.2rem)', fontWeight: 700, color: '#E63946', fontStyle: 'italic', lineHeight: 1.15, letterSpacing: '-2px', margin: '0.3rem 0 0' }}>
                <Words text="They judge them." />
              </h2>
              <p className="s-problem-sub" style={{ fontFamily: 'Inter', fontSize: '1rem', color: '#5A5548', lineHeight: 1.8, maxWidth: 480, marginTop: '2.5rem' }}>
          ...
          <section className="s-number" style={{
            height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center',
          }}>
            <div>
              <div className="big-num" style={{
                fontFamily: "'Playfair Display'", fontSize: 'clamp(7rem,20vw,16rem)',
                fontWeight: 700, color: '#E63946', letterSpacing: '-8px', lineHeight: 0.85,
                textShadow: '0 0 120px rgba(230,57,70,0.15)',
              }}>−0%</div>
              <div className="big-sub" style={{
                fontFamily: "'Playfair Display'", fontStyle: 'italic',
                fontSize: 'clamp(1rem,2vw,1.5rem)', color: '#9A9080', marginTop: '2rem', lineHeight: 1.5,
              }}>
                trust gap between the lightest<br/>and darkest skin tones
              </div>
              <div className="big-p" style={{
          ...
          <section className="s-how" style={{
            minHeight: '100vh', display: 'flex', alignItems: 'center',
            padding: '6rem clamp(3rem,8vw,10rem)', justifyContent: 'flex-end',
          }}>
            <div style={{ maxWidth: 520 }}>
              <div className="how-step" style={{
                ...
                marginBottom: '2.5rem', textAlign: 'right',
              }}>How pixelPrejudice Works</div>
              {[
                { n: '01', t: 'Collect', d: '10,247 faces from FairFace — 47 countries, 6 Fitzpatrick skin types.' },
                { n: '02', t: 'Evaluate', d: 'Each face judged by Qwen3-30B, Qwen2.5-7B, and Phi-3.5 via our agentic pipeline.' },
                ...
                <div key={step.n} className="how-step" style={{ textAlign: 'right', marginBottom: '2.5rem' }}>
          ...
          <section className="s-models" style={{
            minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '6rem 3rem',
          }}>
            <div>
              <div className="model-item" style={{
                fontFamily: 'Inter', fontSize: '0.55rem', fontWeight: 700, letterSpacing: 3,
                color: '#E63946', textTransform: 'uppercase', marginBottom: '1.5rem',
              }}>The Verdict</div>
              <div className="model-item" style={{ marginBottom: '4rem' }}>
                <h2 style={{
                  fontFamily: "'Playfair Display'", fontSize: 'clamp(1.5rem,3vw,2.2rem)', fontWeight: 700,
                  color: '#F0ECE4', letterSpacing: '-1px',
                }}>
              ...
              <div style={{ display: 'flex', gap: 'clamp(3rem,6vw,6rem)', justifyContent: 'center', flexWrap: 'wrap' }}>
                {[
                  ...
                  { name: 'Qwen2.5-7B', score: 894, corr: '-0.106', worst: false },
                  { name: 'Qwen3-30B', score: 911, corr: '-0.089', worst: false },
                ].map(m => (
                  <div key={m.name} className="model-item" style={{ textAlign: 'center' }}>
                    <div style={{
                      fontFamily: "'JetBrains Mono'", fontSize: 'clamp(2.5rem,6vw,4.5rem)', fontWeight: 700,
                      color: m.worst ? '#E63946' : '#F0ECE4', letterSpacing: '-2px',
                      textShadow: m.worst ? '0 0 60px rgba(230,57,70,0.2)' : 'none',
                    }}>
                      <span className="model-score" data-target={m.score}>0</span>
                    </div>
            ...
            <div className="s-cta-inner">
              ...
              <div>
                <Link href="/evidence" style={{
                  display: 'inline-block', background: '#E63946', color: '#F0ECE4',
